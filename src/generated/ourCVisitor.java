...
public interface ourCVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ourCParser#types}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypes(ourCParser.TypesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ourCParser#values_pos_assign}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValues_pos_assign(ourCParser.Values_pos_assignContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ourCParser#expr_dec_bool}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
